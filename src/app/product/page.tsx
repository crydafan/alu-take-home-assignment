...
export default async function ProductPage({
  ...
  const passportId = id?.trim() || product.id;
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <Card size="sm" className="py-0">
              <div className="p-6">
                ...
                <p className="mt-1.5 text-sm leading-relaxed text-muted-foreground">
                  List your pre-loved garments on our circular marketplace. Earn
                  store credit when it sells.
                </p>
                <Button className="mt-4 w-full gap-1.5" variant="secondary">
